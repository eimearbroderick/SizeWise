...
#code inspired by account update code from @venniladeenan at https://www.geeksforgeeks.org/profile-application-using-python-flask-and-mysql/
@app.route('/review' , methods =['GET', 'POST']) 
def review():
    msg= '' 
    if request.method == 'POST' and 'store' in request.form and 'rating' in request.form and 'review' in request.form:  
        ...
        cursor.execute('INSERT INTO reviews VALUES ( ,% s,% s,% s)', (store, rating, review,)) 
